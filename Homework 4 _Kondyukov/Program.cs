...
namespace Homework_4__Kondyukov
{
    class Program
    {
        ...
        #endregion
        /* Task 2 - 2. Реализуйте задачу 1 в виде статического класса StaticClass;
        ...
        class Task2
           {
               ...
               public Task2(int lo) { this.lo = lo; }
               public void Print()
               {
                   for (int i = 0; i < mass.Length; i++)
                   {
                       mass[i] = rnd.Next(100,200);
                       Console.Write($"{mass[i],5} ");
                   }
               }
               public void Sort()
               {
        ...
        #region Helping information from lesson
